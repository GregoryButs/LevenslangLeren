...
namespace AfsprakenbeheerPsycholoog.Data.Migrations
{
    ...
    [Migration("20260418164550_UpdateDeleteBehaviourPatientCorrect")]
    partial class UpdateDeleteBehaviourPatientCorrect
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AfsprakenbeheerPsycholoog.Models.ViewModels.Afspraak.AfspraakDetailViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AfspraakTypeNaam")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PatientTelefoon")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PatientVolledigeNaam")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AfspraakDetailViewModel");
                });

            modelBuilder.Entity("AfsprakenbeheerPsycholoog.Models.ViewModels.Afspraak.AfspraakListViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PatientDetailViewModelId")
                        .HasColumnType("int");

                    b.Property<string>("PatientNaam")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("PatientDetailViewModelId");

                    b.ToTable("AfspraakListViewModel");
                });

            modelBuilder.Entity("AfsprakenbeheerPsycholoog.Models.ViewModels.Patient.PatientDetailViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PatientDetailViewModel");
                });

            modelBuilder.Entity("AfsprakenbeheerPsycholoog.Models.ViewModels.Patient.PatientListViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AantalAfspraken")
                        .HasColumnType("int");
                    ...
                    b.ToTable("PatientListViewModel");
                });
            ...
            modelBuilder.Entity("AfsprakenbeheerPsycholoog.Models.ViewModels.Afspraak.AfspraakListViewModel", b =>
                {
                    b.HasOne("AfsprakenbeheerPsycholoog.Models.ViewModels.Patient.PatientDetailViewModel", null)
                        .WithMany("Afspraken")
                        .HasForeignKey("PatientDetailViewModelId");
                });
