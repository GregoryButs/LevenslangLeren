...
namespace AfsprakenbeheerPsycholoog.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.PhoneNumber != phoneNumber)
            {
                ...
                {
                    StatusMessage = "Onverwachte fout bij het proberen in te stellen van het telefoonnummer.";
